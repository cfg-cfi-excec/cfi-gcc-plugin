...
gcc_plugin.so: ./implementations/gcc_plugin_hcfi.o ./implementations/gcc_plugin_excec.o ./implementations/gcc_plugin_hafix.o ./implementations/gcc_plugin_trampolines.o ./implementations/gcc_plugin_fixer.o gcc_plugin.o main.o 
